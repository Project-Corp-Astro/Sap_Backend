...
exports.trackDatabaseOperation = exports.performanceMiddleware = void 0;
...
class PerformanceMonitor {
     ...
     */
    trackResponseTime(startTime, endTime, endpoint, statusCode) {
        ...
        if (duration > 1000) {
            logger_1.default.warn(`Slow response detected: ${endpoint} took ${duration}ms`, {
                endpoint,
                duration,
                statusCode,
            });
    ...
    trackDatabaseOperation(operation, duration) {
        ...
        if (duration > 500) {
            logger_1.default.warn(`Slow database operation detected: ${operation} took ${duration}ms`, {
                operation,
                duration,
            });
        }
    ...
    updateSystemMetrics() {
        ...
        this.metrics.cpu.usage = this.metrics.cpu.loadAvg[0] * 100 / os_1.default.cpus().length;
        // Update uptime
 ...
 */
const trackDatabaseOperation = async (operation, callback) => {
    const startTime = Date.now();
    try {

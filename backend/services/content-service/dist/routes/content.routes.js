 ...
 */
router.post('/', authMiddleware, roleAuthorization(['admin', 'content_manager']), contentController.createContent);
/**
 ...
 * @access Private (Admin, Content Manager)
 */
router.put('/:contentId', authMiddleware, roleAuthorization(['admin', 'content_manager']), contentController.updateContent);
/**
 * @route DELETE /api/content/:contentId
 * @desc Delete content
 * @access Private (Admin, Content Manager)
 */
router.delete('/:contentId', authMiddleware, roleAuthorization(['admin', 'content_manager']), contentController.deleteContent);
/**
 * @route PATCH /api/content/:contentId/status
 * @desc Update content status
 * @access Private (Admin, Content Manager)
 */
router.patch('/:contentId/status', authMiddleware, roleAuthorization(['admin', 'content_manager']), contentController.updateContentStatus);
/**
 ...
 * @access Private (Admin, Content Manager)
 */
router.post('/categories', authMiddleware, roleAuthorization(['admin', 'content_manager']), contentController.createCategory);

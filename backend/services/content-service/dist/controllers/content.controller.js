...
class ContentController {
    ...
    async getAllContent(req, res, next) {
        try {
            ...
            const result = await contentService.getAllContent(filters, page, limit, sortBy, sortOrder);
...
export const { createContent, getAllContent, getContentById, getContentBySlug, updateContent, deleteContent, updateContentStatus, getAllCategories, createCategory } = new ContentController();

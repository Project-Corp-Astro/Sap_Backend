...
describe('Media Service', () => {
  ...
  describe('createMedia', () => {
    ...
    it('should throw an error if media with same title exists', async () => {
      ...
      await expect(mediaService.createMedia(mockMediaData)).rejects.toThrow(
        'Media with this title already exists'
      );
    });
  });
  ...
  describe('updateMedia', () => {
    ...
    it('should throw an error if updated title already exists', async () => {
      ...
      await expect(mediaService.updateMedia(mediaId, { title: 'Another Media' })).rejects.toThrow(
        'Media with this title already exists'
      );
    });
  });

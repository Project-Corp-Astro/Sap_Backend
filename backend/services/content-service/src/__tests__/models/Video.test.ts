...
import { VideoDocument } from '../../interfaces/video.interfaces.js';
...
describe('Video Model', () => {
  ...
  it('should enforce unique slugs', async () => {
    ...
    // In TypeScript migration, the error handling might have changed
    // Let's modify the test to be more specific about what we're testing
    try {
      await video2.save();
